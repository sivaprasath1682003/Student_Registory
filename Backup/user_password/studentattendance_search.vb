...
Public Class studentattendance_search
    ...
    Private Sub insert_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SEARCH.Click
        Dim Command As New SqlCommand("select * from stu_att where Rollno=@rollno", connection)
        ...
        If table.Rows.Count() > 0 Then
            ...
            ComboBox5.Text = table.Rows(0)(10).ToString()
        Else
    ...
    Private Sub update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles update.Click
        Dim connection As New SqlClient.SqlConnection("Data Source=LAPTOP-T1M8R05D;Initial Catalog=siva;Integrated Security=True")
        If TextBox1rollno.Text = "" Then
            MessageBox.Show("empty rollno")
        Else
            Dim command As New SqlClient.SqlCommand("update stu_att SET Morningprayer=@morningprayer,MReason=@mreason,Afternoonprayer=@afternoonprayer,AReason=areason,Eveningprayer=@eveningprayer,EReason=@ereason,Rollcall=@rollcall,RReason=@rreason,status=@status WHERE Rollno=@rollno", connection)
            command.Parameters.Add("@rollno", SqlDbType.VarChar).Value = TextBox1rollno.Text
            ...
            command.Parameters.Add("@status", SqlDbType.VarChar).Value = ComboBox5.Text
            connection.Open()
